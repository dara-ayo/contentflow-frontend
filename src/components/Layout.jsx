      ...
      >
        ...
        >
          <Link to="/" className="flex items-center gap-2.5 group" onClick={() => setMobileOpen(false)}>
            <div className="w-8 h-8 rounded-xl bg-gradient-accent flex items-center justify-center shadow-glow-sm group-hover:shadow-glow-accent transition-all duration-200 flex-shrink-0">
